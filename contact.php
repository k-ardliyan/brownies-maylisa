<?php
    ...
    session_start();
    $query = "SELECT nama,telepon,email FROM info";
...
<body class="bg-light">
    ...
    <div class="container">
        <div class="card py-4 px-5 mt-5 bg-white shadow-sm">
            <div class="card-body pt-0">
                <h4 class="text-center">Pemilik Toko</h4>
                <input type="text" class="form-control text-center bg-light mt-2" readonly value="<?=$kontak['nama']?>">
                <h4 class="text-center mt-4">Nomor Telepon / Whatsapp</h4>
                <input type="number" class="form-control text-center bg-light mt-3" readonly value="<?=$kontak['telepon']?>">
                <h4 class="text-center mt-3">Email</h4>
                <input type="email" class="form-control text-center bg-light mt-2" readonly value="<?=$kontak['email']?>">
            </div>
        </div>
    <!-- end-container -->
    </div>
